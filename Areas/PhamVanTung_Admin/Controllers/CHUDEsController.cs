...
namespace PhamVanTung.SachOnline.Areas.PhamVanTung_Admin.Controllers
{
    public class CHUDEsController : Controller
    {
        ...
        // GET: PhamVanTung_Admin/CHUDEs/Details/5
        ...
        // GET: PhamVanTung_Admin/CHUDEs/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: PhamVanTung_Admin/CHUDEs/Create
        ...
        // GET: PhamVanTung_Admin/CHUDEs/Edit/5
        ...
        // POST: PhamVanTung_Admin/CHUDEs/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: PhamVanTung_Admin/CHUDEs/Delete/5
        ...
        // POST: PhamVanTung_Admin/CHUDEs/Delete/5
